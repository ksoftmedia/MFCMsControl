...
// DateTimePicker.cpp : Defines the class behaviors for the application.
//
...
// CDateTimePickerApp construction
...
// The one and only CDateTimePickerApp object

CDateTimePickerApp theApp;


// CDateTimePickerApp initialization
